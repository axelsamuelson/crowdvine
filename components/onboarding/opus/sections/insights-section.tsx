...
const articles = [
  {
    ...
    category: "Design",
    image: "/opus/visual-storytelling-design-article.jpg",
  },
  {
    title: "Building a Personal Brand Online",
    category: "Strategy",
    image: "/opus/personal-branding-digital-marketing.jpg",
  },
  {
    title: "Typography Trends for 2024",
    category: "Typography",
    image: "/opus/typography-trends-modern-fonts.jpg",
  },
  {
          ...
          {hoveredIndex !== null && (
            ...
            >
              <img
                ...
                alt={articles[hoveredIndex]?.title || "Preview"}
