...
import { useSliderNavigation } from "./use-slider-navigation";
import { useSliderDrag } from "./use-slider-drag";
import { useSliderWheel } from "./use-slider-wheel";
import { useColorExtraction, useCurrentColors } from "./use-color-extraction";

const CARD_WIDTH_MOBILE = 432;
const CARD_WIDTH_DESKTOP = 564;
...
export function ArtGallerySlider() {
  ...
  useEffect(() => {
    const updateWidth = () => {
      setCardWidth(window.innerWidth > 768 ? CARD_WIDTH_DESKTOP : CARD_WIDTH_MOBILE);
    };
    updateWidth();
    ...
    <div className="relative h-full w-full overflow-hidden">
      ...
      >
        <motion.div
          ...
          animate={{
            x: -currentIndex * cardWidth + dragX,
          }}
