...
import { updateObjective } from "@/lib/actions/operations"
import type { Objective } from "@/lib/types/operations"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { cn } from "@/lib/utils"

export function ObjectiveDetailTitleEditor({
  objectiveId,
  initialTitle,
  onSaved,
}: {
  ...
  async function save() {
    ...
    setSaving(true)
    try {
      const updated = await updateObjective(objectiveId, { title: next })
      setTitle(next)
      setEditing(false)
      toast.success("Saved")
      onSaved?.(updated)
