...
-- Note: numbered 181 because 178 is already promo_discount_codes.
--
-- CREATE OR REPLACE cannot insert/reorder view columns (Postgres 42P16).
-- Drop dependent views, then recreate with the 177 definition so visitor_id
-- from user_events flows through base (ue.*) and site stays last.
