...
var SetupToolbarInternal = ({ title, description, addon = {}, ...props }) => {
  ...
  const checkAllValid = useCallback((envs2) => {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(AnimatePresence, { children: open ? /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "v0-flex v0-items-center v0-justify-between v0-flex-shrink-0 v0-px-4 v0-py-3 v0-border-b v0-border-dashed v0-rounded-t-lg v0-bg-neutral-50 v0-border-neutral-200", children: [
                /* @__PURE__ */ jsxs("div", { className: "v0-flex v0-items-center v0-gap-2", children: [
                  /* @__PURE__ */ jsx(motion.div, { layoutId: "icon", children: /* @__PURE__ */ jsx(AlertTriangle, { className: "v0-size-4 v0-text-amber-600" }) }),
                  /* @__PURE__ */ jsx(motion.span, { layoutId: "title", className: "v0-text-sm v0-font-semibold v0-text-amber-800", children: title })
                ] }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsx(X, { className: "v0-size-4" })
                  }
                )
              ] }),
              /* @__PURE__ */ jsx("div", { className: "v0-flex v0-flex-col v0-flex-1 v0-min-h-0", children: /* @__PURE__ */ jsxs(
                motion.div,
                {
                  exit: { y: 8, opacity: 0 },
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "v0-flex v0-items-center v0-justify-between v0-flex-shrink-0 v0-gap-4 v0-px-3 v0-py-1.5 v0-border-b v0-bg-neutral-100 v0-border-neutral-200", children: [
                      /* @__PURE__ */ jsx("p", { className: "v0-text-xs v0-text-balance v0-text-neutral-600", children: description }),
                      /* @__PURE__ */ jsx("div", { className: "v0-flex v0-items-center v0-justify-center v0-shrink-0", children: /* @__PURE__ */ jsxs("div", { className: "v0-relative v0-size-10", children: [
                        /* @__PURE__ */ jsxs("svg", { className: "v0-transform v0--rotate-90 v0-size-10", viewBox: "0 0 32 32", children: [
                          /* @__PURE__ */ jsx(
                            "circle",
                            {
                              cx: "16",
                        ...
                        /* @__PURE__ */ jsx("div", { className: "v0-absolute v0-inset-0 v0-flex v0-items-center v0-justify-center", children: /* @__PURE__ */ jsxs("span", { className: "v0-text-[10px] v0-font-semibold v0-text-neutral-700 v0-leading-none v0-tabular-nums", children: [
                          validCount,
                          "/",
                          envs.length
                        ] }) })
                    ...
                    /* @__PURE__ */ jsx("div", { className: "v0-flex-1 v0-overflow-y-auto v0-bg-white", children: /* @__PURE__ */ jsx("div", { className: "v0-p-4 v0-pb-6 v0-space-y-3", children: envs.map((env) => /* @__PURE__ */ jsxs(
                      "div",
                      {
                        className: " v0-p-3 v0-border v0-rounded-lg v0-bg-neutral-50 v0-border-neutral-200",
                        children: [
                          /* @__PURE__ */ jsxs("div", { className: "v0-flex v0-items-center v0-gap-3", children: [
                            /* @__PURE__ */ jsx(
                              "div",
                              {
                                ...
                                children: env.isValid ? /* @__PURE__ */ jsx(Check, { className: "v0-size-4" }) : /* @__PURE__ */ jsx(AlertTriangle, { className: "v0-size-4" })
                              }
                            ),
                            /* @__PURE__ */ jsxs("div", { className: "v0-flex-1 v0-min-w-0", children: [
                              /* @__PURE__ */ jsx("div", { className: "v0-text-sm v0-font-medium v0-text-neutral-900", children: env.label }),
                              /* @__PURE__ */ jsx("div", { className: "v0-font-mono v0-text-xs v0-truncate v0-text-neutral-500", children: env.name })
                            ] }),
                            /* @__PURE__ */ jsx(
                              "div",
                              {
                          ...
                          env.script?.content && !env.isValid && /* @__PURE__ */ jsxs("div", { className: "v0-relative v0-mt-4", children: [
                            /* @__PURE__ */ jsx(
                              "button",
                              {
                                ...
                                title: "Copy code",
                                children: copiedScript === env.name ? /* @__PURE__ */ jsx(Check, { className: "v0-size-4" }) : /* @__PURE__ */ jsx(Copy, { className: "v0-size-4" })
                              }
                            ),
                            /* @__PURE__ */ jsx(
                              Prism,
          ...
          motion.button,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(motion.div, { layoutId: "icon", children: /* @__PURE__ */ jsx(AlertTriangle, { className: "v0-w-4 v0-h-4 v0-text-amber-600" }) }),
              /* @__PURE__ */ jsx(motion.span, { layoutId: "title", className: "v0-block v0-text-sm v0-text-amber-800", children: title })
            ]
          },
          "button"
        ) })
...
var SetupToolbar = (props) => {
  ...
  const mountInstanceIdRef = useRef(null);
  ...
  return portalContainer ? createPortal(/* @__PURE__ */ jsx(SetupToolbarInternal, { ...props }), portalContainer) : null;
};

// packages/core/index.ts
var VERSION = version;

export { CSS_CONTENT, SetupToolbar, VERSION, cn, injectStyles };
