...
import { createEmitter, debounce, debounceController, defaultRateLimit, globalThrottleQueue, throttle } from "./debounce-CmqzOOem.js";
import { debug, renderQueryString, useAdapter, useAdapterDefaultOptions, warn } from "./context-BWo_DoaC.js";
...
function useQueryStates(keyMap, options = {}) {
	...
	const update = useCallback((stateUpdater, callOptions = {}) => {
		...
		const globalPromise = debounceAborts.reduce((previous, fn) => fn(previous), globalThrottleQueue.flush(adapter));
