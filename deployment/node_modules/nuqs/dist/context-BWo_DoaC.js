...
function createAdapterProvider(useAdapter$1) {
	return ({ children, defaultOptions,...props }) => createElement(context.Provider, {
		...props,
		value: {
...
//#endregion
export { context, createAdapterProvider, debug, error, renderQueryString, useAdapter, useAdapterDefaultOptions, warn };
//# sourceMappingURL=context-BWo_DoaC.js.map