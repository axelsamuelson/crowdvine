...
2. Create `.env.local` with your Supabase, Stripe, and Resend credentials:
...
# Optional: verified sender in Resend (default PACT <noreply@pactwines.com>)
# RESEND_FROM=PACT <orders@yourdomain.com>
