...
const EVENT_TYPE_LABELS_SV: Readonly<Record<string, string>> = {
  ...
  checkout_postal_started: "Började fylla i postnummer",
  checkout_delivery_captured: "Leveransuppgifter sparade",
  checkout_zone_error: "Leveranszon fel",
  checkout_stripe_confirm_failed: "Kortnekat i Stripe",
  ...
  cart_validation_shown: "Visade 6-pack-validering",
  cart_validation_passed: "6-pack validerad",
  cart_validation_failed: "6-pack validering misslyckades",
