...
export async function renderJeanPaulThevenetGuidePage() {
  ...
  return (
    <>
      ...
      <ArticleGuideShell
        h1={jeanPaulThevenetGuide.h1}
        lede={jeanPaulThevenetGuide.hubCard.description}
        sections={jeanPaulThevenetGuide.sections}
        furtherReadingHeading={jeanPaulThevenetGuide.furtherReadingHeading}
        internalLinks={jeanPaulThevenetGuide.links}
        breadcrumb={
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>{jeanPaulThevenetGuide.breadcrumbShort}</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        }
