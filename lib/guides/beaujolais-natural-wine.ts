/** English-only regional guide: Beaujolais natural wine. */

export const BEAUJOLAIS_NATURAL_WINE_GUIDE_PATH =
  "/guides/beaujolais-natural-wine" as const;
...
export const beaujolaisNaturalWineGuide = {
  ...
  sections: [
    {
      heading: "The problem with Beaujolais",
      paragraphs: [
