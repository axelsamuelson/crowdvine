  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="space-y-4 mb-6">
        ...
        <Button onClick={testCookieComparison} disabled={!wineId} variant="outline">
      ...
      <div className="mt-4 p-4 border rounded">
        ...
        <ol className="list-decimal list-inside space-y-1">
          ...
          <li>Click "Test Shop AddItem Server Action" to test the exact server action shop uses</li>
          <li>Click "Test Direct API Call" to test the same flow with direct API calls</li>
          <li>Click "Test Cookie Comparison" to compare cookie behavior between server action and direct API</li>
          <li>Check browser console for detailed logs</li>
          <li>Compare results to understand why server action fails but direct API works</li>
        </ol>
      </div>
    </div>
  );
