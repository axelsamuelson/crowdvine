...
import { LivingPalletVisualization } from "@/components/home-concepts/living-pallet-visualization";
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm border-b border-border p-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <Badge variant="default">Concept 1: In Development</Badge>
          </div>
            ...
            <div className="fixed top-20 left-0 z-10 w-full pointer-events-none base-grid py-sides">
              <div className="col-span-8 col-start-5">
                <div className="hidden px-6 lg:block">
                  <Badge variant="outline-secondary">levande nätverk</Badge>
                </div>
              </div>
            </div>
