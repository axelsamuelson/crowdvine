...
export default function BulkUploadPage() {
  ...
  const handleParse = async () => {
    ...
    try {
      ...
      setParseProgress({
        ...
        percentage: 5,
        details: `Processing ${file.name} (${file.size > 1024 ? (file.size / 1024).toFixed(1) + " KB" : file.size + " bytes"})`,
      });
      ...
      setParseProgress({
        ...
        percentage: 15,
        details: `Uploading file to server...`,
      });
      ...
      setParseProgress({
        ...
        percentage: 60,
        details: `Server processing complete, parsing ${Math.round(rows)} estimated rows`,
      });
      ...
      setParseProgress({
        ...
        percentage: 95,
        details: `Found ${data.products?.length || 0} products`,
      });
      ...
      // Stage 5: Complete
      setParseProgress({
        stage: "Parse complete!",
        percentage: 100,
        details: `Ready to review ${data.products?.length || 0} products`,
      });
      ...
      if (response.ok) {
        ...
        setStep("review");
        toast.success(
          `CSV parsed successfully. Found ${data.products.length} products to review`,
        );
      ...
      setParseProgress({
        stage: "Parse failed!",
        percentage: 0,
        details: "An error occurred during parsing",
      });
      setResult({
        success: false,
  ...
  const handleConfirmUpload = async () => {
    const productsToUpload = reviewProducts.filter((_, index) =>
  ...
  const downloadTemplate = () => {
    ...
    window.open(
      `/templates/bulk-products-template.csv?v=${timestamp}`,
      "_blank",
    );
  };
    ...
    <div className="container mx-auto py-8 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Upload multiple wine products at once using a CSV file. This saves
          time when adding many products to your inventory.
        </p>
      </div>
              ...
              <div className="space-y-3 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-gray-500 font-mono">
                    {parseProgress.percentage}%
                  </span>
                </div>
                <Progress
                  value={parseProgress.percentage}
          ...
          <CardContent>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                ...
                <div>
                  Short product description (optional - auto-generated if empty)
                </div>
              ...
              <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="text-sm text-blue-900">
                  <strong>Auto-generated:</strong> Handle (wine-name-vintage)
                  and alcohol tax (22.19 SEK) are automatically added.
                  <br />
                  <strong>Default image:</strong> All bulk upload wines will use
                  the same "Coming Soon" image unless Image URL is specified.
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div className="text-sm text-yellow-800">
                <strong>⚠️ If you get CSV parsing errors:</strong> Make sure to
                download the latest template from above. Old templates may have
                different column names like "Base Price (SEK)" and "Handle"
        ...
        {step === "review" && reviewProducts.length > 0 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Review each product and select which ones to upload. Check
                producer names for typos.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {/* Selection Controls */}
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="text-xs text-gray-500 mt-1">
                              ...
                              {product.grape_varieties} • {product.color}
                            </div>
                        ...
                        <div className="mt-3 space-y-3">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                newProducts[index].grape_varieties =
                                  e.target.value;
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const newProducts = [...reviewProducts];
                                newProducts[index].producer_name =
                                  e.target.value;
                                setReviewProducts(newProducts);
                              }}
                              className="flex-1 text-sm border border-gray-300 rounded px-2 py-1"
                          ...
                          {product.rowIssues &&
                            product.rowIssues.length > 0 && (
                              <div className="mt-2 space-y-1">
                                {product.rowIssues.map(
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                {result.success
                  ? "Upload Complete"
                  : "CSV Parsing Failed - Detailed Report"}
              </CardTitle>
              <CardDescription>
                {result.success
                  ? "Your products have been processed."
                  : "Detailed breakdown of what went wrong with your CSV."}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                {result.details && !result.success && (
                  <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                          <div className="text-center p-3 bg-white rounded">
                            <div className="text-xl font-bold text-gray-900">
                              {result.details.summary.totalRows}
                            </div>
                          ...
                          <div className="text-center p-3 bg-orange-100 rounded">
                            <div className="text-xl font-bold text-orange-700">
                              {result.details.summary.rowErrors}
                            </div>
                        ...
                        <div className="space-y-3">
                          <div>
                            ...
                            <code className="block bg-white p-2 rounded text-xs break-all">
                              {result.details.csvStructure.headerRow}
                            </code>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <div className="space-y-1">
                                {result.details.csvStructure.expectedHeaders.map(
                                  (header, idx) => (
                                    <div
                                      key={idx}
                                      className={`text-xs px-2 py-1 rounded ${
                                        result.details?.csvStructure?.actualHeaders.includes(
                                          header,
                                        )
                            ...
                            <div>
                              ...
                              <div className="space-y-1">
                                {result.details.csvStructure.actualHeaders.map(
                                  (header, idx) => (
                                    <div
                                      key={idx}
                              ...
                              {result.details.csvStructure.columnCount !==
                                result.details.csvStructure.expectedHeaders
                                  .length && (
                          ...
                          <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                            <div className="text-sm text-red-800">
                              <strong>💡 Quick Fix:</strong> Download the latest
                              CSV template above and copy your data into it,
                              ensuring all headers match exactly
                              (case-sensitive).
                            </div>
                          </div>
                        </div>
                    ...
                    {/* Header Issues */}
                    {result.details.headerIssues &&
                      result.details.headerIssues.length > 0 && (
                        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                          ...
                          <div className="space-y-2">
                            {result.details.headerIssues.map((issue, idx) => (
                              <div
                                key={idx}
                                className="p-2 bg-red-100 border border-red-300 rounded text-sm text-red-800"
                              >
                                {issue}
                              </div>
                            ))}
                    ...
                    {/* Row Issues */}
                    {result.details.rowIssues &&
                      result.details.rowIssues.length > 0 && (
                        <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                          ...
                          <div className="space-y-2 max-h-48 overflow-y-auto">
                            {result.details.rowIssues.map((issue, idx) => (
                              <div
                                key={idx}
                                className="p-2 bg-orange-100 border border-orange-300 rounded text-sm text-orange-800"
                              >
                                {issue}
                              </div>
                            ))}
                    ...
                    {result.details.debugInfo && (
                      <div className="bg-gray-100 border border-gray-300 rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            <strong>File:</strong>{" "}
                            {result.details.debugInfo.fileName}
                          </div>
                          <div>
                            <strong>Size:</strong>{" "}
                            {(result.details.debugInfo.fileSize / 1024).toFixed(
                              1,
                            )}{" "}
                            KB
                          </div>
                          <div>
                            <strong>Lines:</strong>{" "}
                            {result.details.debugInfo.fileLines}
                          </div>
                          <div>
                            <strong>Has Content:</strong>{" "}
                            {result.details.debugInfo.hasContent ? "Yes" : "No"}
                          </div>
                ...
                <div className="flex gap-3 pt-4 border-t">
                  ...
                  <Button onClick={() => setResult(null)}>Clear Results</Button>
                </div>
              </div>
            </CardContent>
          </Card>
