...
export async function PUT(
  ...
  try {
    ...
    if (body.address_postcode !== undefined) updateData.address_postcode = body.address_postcode;
    if (body.short_description !== undefined) updateData.short_description = body.short_description;
    if (body.logo_image_path !== undefined) updateData.logo_image_path = body.logo_image_path;
    if (body.pickup_zone_id !== undefined) updateData.pickup_zone_id = body.pickup_zone_id || null;
